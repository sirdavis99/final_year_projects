...
class Validator {
  ...
  public function run_input_validation($config, $file_config=FALSE){
      ...
      if($file_config):
          ...
          if(is_array($file_config)):
            ...
            $result = ["error_msgs"=>["file"=>"Invalid Image Configuration"]];
          endif;
    endif;
  ...
  public function upload_file(array $econfig){
     $config = array(
            'upload_path' => isset($econfig['folder']) ? $econfig['folder'] : './uploads/',
            'allowed_types' => isset($econfig['allowed']) ? $econfig['allowed'] : 'jpg|png',
            'max_size'     => isset($econfig['max_size']) ? $econfig['max_size'] : '12000',
            'max_width' => isset($econfig['max_width']) ? $econfig['max_width'] : '1000',
            'max_height' => isset($econfig['max_height']) ? $econfig['max_height'] :'1000',
            'encrypt_name' => TRUE
        );
